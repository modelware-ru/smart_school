...
export default class SignInForm {
    ...
    constructor(settings = {}) {
        ...
        this._atm.passwordInput = <Input className="col-12" label={i18n(langId, 'TTL_PASSWORD')} type="password" mandatory />;
    ...
    _showError = ({ status, data }) => {
        ...
        if (typeof data[ID.SIF_INPUT_LOGIN_ID] !== 'undefined') {
            ...
            this._updateStateLoginInput({ disabled: false, hasError: 'undefined', error: null });
        }
        ...
        if (typeof data[ID.SIF_INPUT_PASSWORD_ID] !== 'undefined') {
            ...
            this._updateStatePasswordInput({ disabled: false, hasError: 'undefined', error: null });
        }
    };
        ...
        return (
            <div>
                ...
                <form class="mt-3 row gx-0 gy-3">
                    ...
                    <a href="recoveryPassword.php" class="link-primary text-center">
