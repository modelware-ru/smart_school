...
export default class TeacherForm {
    ...
    constructor(settings = {}) {
        ...
        this._updateStateInput(ID.TF_INPUT_LOGIN_ID, {
            disabled: false,
            hasError: 'unknown',
        });
        ...
        this._updateStateInput(ID.TF_INPUT_PASSWORD_ID, {
            disabled: false,
            hasError: 'unknown',
        });
        ...
        this._updateStateInput(ID.TF_INPUT_FIRSTNAME_ID, {
            disabled: false,
            hasError: 'unknown',
        });
        ...
        this._updateStateInput(ID.TF_INPUT_LASTNAME_ID, {
            disabled: false,
            hasError: 'unknown',
        });
        ...
        this._updateStateInput(ID.TF_INPUT_MIDDLENAME_ID, {
            disabled: false,
            hasError: 'unknown',
        });
        ...
        this._updateStateInput(ID.TF_INPUT_EMAIL_ID, {
            disabled: false,
            hasError: 'unknown',
        });
    ...
    _showError = ({ status, data }) => {
        if (status === 'ok') {
            this._updateStateInput(ID.TF_INPUT_FIRSTNAME_ID, { disabled: false, hasError: 'no', error: null });
            this._updateStateInput(ID.TF_INPUT_LASTNAME_ID, { disabled: false, hasError: 'no', error: null });
            this._updateStateInput(ID.TF_INPUT_MIDDLENAME_ID, { disabled: false, hasError: 'no', error: null });
            this._updateStateInput(ID.TF_INPUT_LOGIN_ID, { disabled: false, hasError: 'no', error: null });
            this._updateStateInput(ID.TF_INPUT_EMAIL_ID, { disabled: false, hasError: 'no', error: null });
            this._updateStateInput(ID.TF_INPUT_PASSWORD_ID, { disabled: false, hasError: 'no', error: null });
            this._updateStateRoleStateSelect({ disabled: false, hasError: 'no', error: null });
            return;
        }

        if (status === 'error') {
            this._updateStateInput(ID.TF_INPUT_FIRSTNAME_ID, { disabled: false, hasError: 'undefine', error: null });
            this._updateStateInput(ID.TF_INPUT_LASTNAME_ID, { disabled: false, hasError: 'undefine', error: null });
            this._updateStateInput(ID.TF_INPUT_MIDDLENAME_ID, { disabled: false, hasError: 'undefine', error: null });
            this._updateStateInput(ID.TF_INPUT_LOGIN_ID, { disabled: false, hasError: 'undefine', error: null });
            this._updateStateInput(ID.TF_INPUT_EMAIL_ID, { disabled: false, hasError: 'undefine', error: null });
            this._updateStateInput(ID.TF_INPUT_PASSWORD_ID, { disabled: false, hasError: 'undefine', error: null });
        ...
        if (typeof data[ID.TF_INPUT_FIRSTNAME_ID] !== 'undefined') {
            this._updateStateInput(ID.TF_INPUT_FIRSTNAME_ID, { disabled: false, hasError: 'yes', error: data[ID.TF_INPUT_FIRSTNAME_ID] });
        } else {
            this._updateStateInput(ID.TF_INPUT_FIRSTNAME_ID, { disabled: false, hasError: 'undefined', error: null });
        }

        if (typeof data[ID.TF_INPUT_LASTNAME_ID] !== 'undefined') {
            this._updateStateInput(ID.TF_INPUT_LASTNAME_ID, { disabled: false, hasError: 'yes', error: data[ID.TF_INPUT_LASTNAME_ID] });
        } else {
            this._updateStateInput(ID.TF_INPUT_LASTNAME_ID, { disabled: false, hasError: 'undefined', error: null });
        }

        if (typeof data[ID.TF_INPUT_MIDDLENAME_ID] !== 'undefined') {
            this._updateStateInput(ID.TF_INPUT_MIDDLENAME_ID, { disabled: false, hasError: 'yes', error: data[ID.TF_INPUT_MIDDLENAME_ID] });
        } else {
            this._updateStateInput(ID.TF_INPUT_MIDDLENAME_ID, { disabled: false, hasError: 'undefined', error: null });
        }
        ...
        if (typeof data[ID.TF_INPUT_LOGIN_ID] !== 'undefined') {
            this._updateStateInput(ID.TF_INPUT_LOGIN_ID, { disabled: false, hasError: 'yes', error: data[ID.TF_INPUT_LOGIN_ID] });
        } else {
            this._updateStateInput(ID.TF_INPUT_LOGIN_ID, { disabled: false, hasError: 'undefined', error: null });
        }

        if (typeof data[ID.TF_INPUT_EMAIL_ID] !== 'undefined') {
            this._updateStateInput(ID.TF_INPUT_EMAIL_ID, { disabled: false, hasError: 'yes', error: data[ID.TF_INPUT_EMAIL_ID] });
        } else {
            this._updateStateInput(ID.TF_INPUT_EMAIL_ID, { disabled: false, hasError: 'undefined', error: null });
        }

        if (typeof data[ID.TF_INPUT_PASSWORD_ID] !== 'undefined') {
            this._updateStateInput(ID.TF_INPUT_PASSWORD_ID, { disabled: false, hasError: 'yes', error: data[ID.TF_INPUT_PASSWORD_ID] });
        } else {
            this._updateStateInput(ID.TF_INPUT_PASSWORD_ID, { disabled: false, hasError: 'undefined', error: null });
        }
    };

    _beforeCallSaveTeacher = () => {
        this._updateStateSaveButton({ disabled: true, isLoading: true, title: 'TTL_TO_SAVE_IN_PROGRESS' });
        this._updateStateInput(ID.TF_INPUT_FIRSTNAME_ID, { disabled: true });
        this._updateStateInput(ID.TF_INPUT_LASTNAME_ID, { disabled: true });
        this._updateStateInput(ID.TF_INPUT_MIDDLENAME_ID, { disabled: true });
        this._updateStateInput(ID.TF_INPUT_LOGIN_ID, { disabled: true });
        this._updateStateInput(ID.TF_INPUT_EMAIL_ID, { disabled: true });
        this._updateStateInput(ID.TF_INPUT_PASSWORD_ID, { disabled: true });
