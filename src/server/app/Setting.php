...
class Setting
{
    private const _DATA = [
        ...
        'app' => [
            ...
            // модуль: account
            'account' => [
                // 'соль' для хеширования регистрационного кода
                'codeSecret' => 'C45vqbFhwZ',
                // время, после которого можно повторно запросить кода для регистрации, в секундах
                'codeRepeatTime' => 10,
                // время, после которого код для регистрации становится не валидным, в минутах
                'codeExpiryTime' => 30,
                // длина регистрационного кода (связано с полем reg_code.hash)
                'codeLength' => 4,
