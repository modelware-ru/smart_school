...
list($res, $data) = (new StudentModule())->getStudentSerieList($args);
...
<head>
    ...
    <script type='text/javascript' src='js/teacher_studentSerieList_bundle.js' defer></script>
</head>
...
<body>
    <div class="container">
        ...
        <div id="main">
            <div id="student-serie-list-header"></div>
        </div>
